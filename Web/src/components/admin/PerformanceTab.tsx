  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-foreground">System Performance</h2>
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-sm border border-foreground/20 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            >
...
function ApiRoutesTab({ timeRange }: ApiRoutesTabProps) {
  ...
  const getDataSourceBadge = () => {
    switch (dataSource) {
      ...
      default:
        return { label: 'Unknown', icon: Wifi, color: 'text-foreground-secondary bg-background-secondary' };
    }
  };
    ...
    <div className="space-y-4">
      <div className="bg-background-secondary p-6 rounded-xl shadow-xs border border-glass-border">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-foreground">API Routes Performance</h3>
          <div className="flex items-center gap-3">
