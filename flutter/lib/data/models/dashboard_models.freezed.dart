...
@useResult
$Res call({
 String id, String stravaId, ActivityType type, String name, DateTime startDate, double distance, int movingTime, double? averageSpeed, double? averageHr, int? maxHr, double? averageCadence, bool hasHeartrate,@JsonKey(fromJson: _parseDouble) double totalElevation, double? trimp, double? runningTss, double? estimatedVdot, String? trainingType,@JsonKey(name: 'hrZone1Time') int hrZone1Time,@JsonKey(name: 'hrZone2Time') int hrZone2Time,@JsonKey(name: 'hrZone3Time') int hrZone3Time,@JsonKey(name: 'hrZone4Time') int hrZone4Time,@JsonKey(name: 'hrZone5Time') int hrZone5Time,@JsonKey(name: 'hrZone6Time') int hrZone6Time,@JsonKey(name: 'hrZone7Time') int hrZone7Time,@JsonKey(name: 'streams') Map<String, dynamic>? streams,@JsonKey(name: 'calories') double? calories,@JsonKey(name: 'averageWatts') double? averageWatts,@JsonKey(name: 'weightedAverageWatts') double? weightedAverageWatts,@JsonKey(name: 'deviceWatts') bool deviceWatts
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String stravaId,  ActivityType type,  String name,  DateTime startDate,  double distance,  int movingTime,  double? averageSpeed,  double? averageHr,  int? maxHr,  double? averageCadence,  bool hasHeartrate, @JsonKey(fromJson: _parseDouble)  double totalElevation,  double? trimp,  double? runningTss,  double? estimatedVdot,  String? trainingType, @JsonKey(name: 'hrZone1Time')  int hrZone1Time, @JsonKey(name: 'hrZone2Time')  int hrZone2Time, @JsonKey(name: 'hrZone3Time')  int hrZone3Time, @JsonKey(name: 'hrZone4Time')  int hrZone4Time, @JsonKey(name: 'hrZone5Time')  int hrZone5Time, @JsonKey(name: 'hrZone6Time')  int hrZone6Time, @JsonKey(name: 'hrZone7Time')  int hrZone7Time, @JsonKey(name: 'streams')  Map<String, dynamic>? streams, @JsonKey(name: 'calories')  double? calories, @JsonKey(name: 'averageWatts')  double? averageWatts, @JsonKey(name: 'weightedAverageWatts')  double? weightedAverageWatts, @JsonKey(name: 'deviceWatts')  bool deviceWatts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String stravaId,  ActivityType type,  String name,  DateTime startDate,  double distance,  int movingTime,  double? averageSpeed,  double? averageHr,  int? maxHr,  double? averageCadence,  bool hasHeartrate, @JsonKey(fromJson: _parseDouble)  double totalElevation,  double? trimp,  double? runningTss,  double? estimatedVdot,  String? trainingType, @JsonKey(name: 'hrZone1Time')  int hrZone1Time, @JsonKey(name: 'hrZone2Time')  int hrZone2Time, @JsonKey(name: 'hrZone3Time')  int hrZone3Time, @JsonKey(name: 'hrZone4Time')  int hrZone4Time, @JsonKey(name: 'hrZone5Time')  int hrZone5Time, @JsonKey(name: 'hrZone6Time')  int hrZone6Time, @JsonKey(name: 'hrZone7Time')  int hrZone7Time, @JsonKey(name: 'streams')  Map<String, dynamic>? streams, @JsonKey(name: 'calories')  double? calories, @JsonKey(name: 'averageWatts')  double? averageWatts, @JsonKey(name: 'weightedAverageWatts')  double? weightedAverageWatts, @JsonKey(name: 'deviceWatts')  bool deviceWatts)  $default,) {final _that = this;
switch (_that) {
case _Activity():
return $default(_that.id,_that.stravaId,_that.type,_that.name,_that.startDate,_that.distance,_that.movingTime,_that.averageSpeed,_that.averageHr,_that.maxHr,_that.averageCadence,_that.hasHeartrate,_that.totalElevation,_that.trimp,_that.runningTss,_that.estimatedVdot,_that.trainingType,_that.hrZone1Time,_that.hrZone2Time,_that.hrZone3Time,_that.hrZone4Time,_that.hrZone5Time,_that.hrZone6Time,_that.hrZone7Time,_that.streams,_that.calories,_that.averageWatts,_that.weightedAverageWatts,_that.deviceWatts);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String stravaId,  ActivityType type,  String name,  DateTime startDate,  double distance,  int movingTime,  double? averageSpeed,  double? averageHr,  int? maxHr,  double? averageCadence,  bool hasHeartrate, @JsonKey(fromJson: _parseDouble)  double totalElevation,  double? trimp,  double? runningTss,  double? estimatedVdot,  String? trainingType, @JsonKey(name: 'hrZone1Time')  int hrZone1Time, @JsonKey(name: 'hrZone2Time')  int hrZone2Time, @JsonKey(name: 'hrZone3Time')  int hrZone3Time, @JsonKey(name: 'hrZone4Time')  int hrZone4Time, @JsonKey(name: 'hrZone5Time')  int hrZone5Time, @JsonKey(name: 'hrZone6Time')  int hrZone6Time, @JsonKey(name: 'hrZone7Time')  int hrZone7Time, @JsonKey(name: 'streams')  Map<String, dynamic>? streams, @JsonKey(name: 'calories')  double? calories, @JsonKey(name: 'averageWatts')  double? averageWatts, @JsonKey(name: 'weightedAverageWatts')  double? weightedAverageWatts, @JsonKey(name: 'deviceWatts')  bool deviceWatts)?  $default,) {final _that = this;
switch (_that) {
case _Activity() when $default != null:
return $default(_that.id,_that.stravaId,_that.type,_that.name,_that.startDate,_that.distance,_that.movingTime,_that.averageSpeed,_that.averageHr,_that.maxHr,_that.averageCadence,_that.hasHeartrate,_that.totalElevation,_that.trimp,_that.runningTss,_that.estimatedVdot,_that.trainingType,_that.hrZone1Time,_that.hrZone2Time,_that.hrZone3Time,_that.hrZone4Time,_that.hrZone5Time,_that.hrZone6Time,_that.hrZone7Time,_that.streams,_that.calories,_that.averageWatts,_that.weightedAverageWatts,_that.deviceWatts);case _:
  return null;
...
@override@JsonKey(fromJson: _parseDouble) final  double totalElevation;
