...
fun PlanSpec.toCreatePlanRequest(): CreatePlanRequest {
    ...
    return CreatePlanRequest(
        ...
        startWeeklyMileage = startWeeklyKm?.times(1000.0),
        ...
        swimDay = swimDay?.let { dowToServerDay(it) },
        ...
        customSwimDistM = customSwimKm?.let { it * 1000.0 },
        customBikeDistM = customBikeKm?.let { it * 1000.0 },
        customRunDistM = customRunKm?.let { it * 1000.0 },
        backyardLoopDistM = backyardLoopKm?.let { it * 1000.0 },
        targetLaps = targetLaps,
        maxHeartRate = maxHeartRate,
        restingHeartRate = restingHeartRate,
        thresholdHeartRate = thresholdHeartRate,
        thresholdPaceSecondsPerKm = thresholdPaceSecPerKm?.toDouble(),
        planSource = "mobile",
    )
}
