        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center p-6">
                <div className="text-center space-y-3">
                    <p className="text-sm text-foreground-secondary">Plan not found or an error occurred.</p>
                    <button
                        type="button"
                        onClick={() => router.push('/plan-advanced')}
                        className="px-4 py-2 rounded-lg bg-background-tertiary text-foreground-secondary text-sm hover:bg-foreground/15 transition-colors"
                    >
                        Back to Plans
                    </button>
                </div>
