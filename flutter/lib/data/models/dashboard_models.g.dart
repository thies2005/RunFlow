...
_Activity _$ActivityFromJson(Map<String, dynamic> json) => _Activity(
  ...
  hrZone6Time: (json['hrZone6Time'] as num?)?.toInt() ?? 0,
  hrZone7Time: (json['hrZone7Time'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$ActivityToJson(_Activity instance) => <String, dynamic>{
  ...
  'hrZone6Time': instance.hrZone6Time,
  'hrZone7Time': instance.hrZone7Time,
