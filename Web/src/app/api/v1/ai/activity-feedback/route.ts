...
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            const result = await generateAndSaveActivityFeedback(activityId, userId, regenerate);
            ...
            if (error.message.includes('Usage limit reached') || error.message.includes('No tokens remaining')) {
