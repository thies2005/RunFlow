...
**[>>> Click here for comprehensive documentation <<<](DOCUMENTATION.md)** — Full API reference, metrics formulas, component architecture, and development guide.

> **New:** Android Mobile App Support is now available! See [Mobile API Documentation](MOBILE_API.md).
...
| `JWT_SECRET` | Required for Mobile App. Generate with: `openssl rand -base64 32`. |
| `JWT_ACCESS_EXPIRY` | Token expiry (default: "24h"). |
