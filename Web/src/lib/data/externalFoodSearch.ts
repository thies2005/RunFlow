                ...
                setTimeout(async () => {
                    try {
                        await prisma.offFoodCache.upsert({
                            where: { query: normalizedQuery },
                            update: { results: results as unknown as Prisma.InputJsonValue, updatedAt: new Date() },
                            create: { query: normalizedQuery, results: results as unknown as Prisma.InputJsonValue },
                        });
                ...
                setTimeout(async () => {
                    try {
                        await prisma.fatSecretFoodCache.upsert({
                            where: { query: normalizedQuery },
                            update: { results: mapped as unknown as Prisma.InputJsonValue, updatedAt: new Date() },
                            create: { query: normalizedQuery, results: mapped as unknown as Prisma.InputJsonValue },
                        });
                    } catch { /* ignore cache write errors */ }
                }, 0);
            }
