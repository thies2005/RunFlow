          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className={`text-3xl font-bold ${
                analytics.adherenceScore >= 80 ? 'text-green-400' :
              ...
              <>
                ...
                <div className={`p-3 rounded-lg border ${
                  ...
                  <div className={`text-lg font-bold mt-1 ${
                    analytics.avgDaily.sugar > MICRO_LIMITS.sugar ? 'text-red-400' : 'text-white'
                  }`}>
                ...
                <div className={`p-3 rounded-lg border ${
                  ...
                  <div className={`text-lg font-bold mt-1 ${
                    analytics.avgDaily.sodium > MICRO_LIMITS.sodium ? 'text-red-400' : 'text-white'
                  }`}>
