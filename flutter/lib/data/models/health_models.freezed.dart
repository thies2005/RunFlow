...
switch (_that) {
case _FoodItem():
return $default(_that.id,_that.name,_that.calories,_that.protein,_that.carbs,_that.fat,_that.servingSize,_that.brand,_that.barcode,_that.favoriteId);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@useResult
$Res call({
 int id, String? serverId, String name,@JsonKey(name: 'amount', fromJson: _parseSupplementAmount) double amount,@JsonKey(name: 'unit') String unit,@JsonKey(name: 'timeOfDay') String timeOfDay,@JsonKey(name: 'daysOfWeek', fromJson: _parseDaysOfWeek, toJson: _serializeDaysOfWeek) List<int> daysOfWeek, bool isActive,@JsonKey(name: 'stackId') String? stackId, int order,@JsonKey(name: 'dosage') String dosage,@JsonKey(name: 'frequency') String frequency
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? serverId,  String name, @JsonKey(name: 'amount', fromJson: _parseSupplementAmount)  double amount, @JsonKey(name: 'unit')  String unit, @JsonKey(name: 'timeOfDay')  String timeOfDay, @JsonKey(name: 'daysOfWeek', fromJson: _parseDaysOfWeek, toJson: _serializeDaysOfWeek)  List<int> daysOfWeek,  bool isActive, @JsonKey(name: 'stackId')  String? stackId,  int order, @JsonKey(name: 'dosage')  String dosage, @JsonKey(name: 'frequency')  String frequency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Supplement() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? serverId,  String name, @JsonKey(name: 'amount', fromJson: _parseSupplementAmount)  double amount, @JsonKey(name: 'unit')  String unit, @JsonKey(name: 'timeOfDay')  String timeOfDay, @JsonKey(name: 'daysOfWeek', fromJson: _parseDaysOfWeek, toJson: _serializeDaysOfWeek)  List<int> daysOfWeek,  bool isActive, @JsonKey(name: 'stackId')  String? stackId,  int order, @JsonKey(name: 'dosage')  String dosage, @JsonKey(name: 'frequency')  String frequency)  $default,) {final _that = this;
switch (_that) {
case _Supplement():
return $default(_that.id,_that.serverId,_that.name,_that.amount,_that.unit,_that.timeOfDay,_that.daysOfWeek,_that.isActive,_that.stackId,_that.order,_that.dosage,_that.frequency);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? serverId,  String name, @JsonKey(name: 'amount', fromJson: _parseSupplementAmount)  double amount, @JsonKey(name: 'unit')  String unit, @JsonKey(name: 'timeOfDay')  String timeOfDay, @JsonKey(name: 'daysOfWeek', fromJson: _parseDaysOfWeek, toJson: _serializeDaysOfWeek)  List<int> daysOfWeek,  bool isActive, @JsonKey(name: 'stackId')  String? stackId,  int order, @JsonKey(name: 'dosage')  String dosage, @JsonKey(name: 'frequency')  String frequency)?  $default,) {final _that = this;
switch (_that) {
case _Supplement() when $default != null:
return $default(_that.id,_that.serverId,_that.name,_that.amount,_that.unit,_that.timeOfDay,_that.daysOfWeek,_that.isActive,_that.stackId,_that.order,_that.dosage,_that.frequency);case _:
  return null;
...
switch (_that) {
case _FoodLogEntry():
return $default(_that.id,_that.mealType,_that.name,_that.quantity,_that.calories,_that.protein,_that.carbs,_that.fat,_that.foodItemId);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _FoodLogEntry extends FoodLogEntry {
  const _FoodLogEntry({this.id = '', required this.mealType, required this.name, this.quantity, this.calories, this.protein, this.carbs, this.fat, this.foodItemId}): super._();
...
@JsonKey(name: 'adherenceScore') double get macroAdherenceScore; List<DailyNutrition> get dailyData; List<MicronutrientSummary> get micronutrients;
...
@useResult
$Res call({
@JsonKey(name: 'adherenceScore') double macroAdherenceScore, List<DailyNutrition> dailyData, List<MicronutrientSummary> micronutrients
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'adherenceScore')  double macroAdherenceScore,  List<DailyNutrition> dailyData,  List<MicronutrientSummary> micronutrients)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NutritionAnalytics() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'adherenceScore')  double macroAdherenceScore,  List<DailyNutrition> dailyData,  List<MicronutrientSummary> micronutrients)  $default,) {final _that = this;
switch (_that) {
case _NutritionAnalytics():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'adherenceScore')  double macroAdherenceScore,  List<DailyNutrition> dailyData,  List<MicronutrientSummary> micronutrients)?  $default,) {final _that = this;
switch (_that) {
case _NutritionAnalytics() when $default != null:
return $default(_that.macroAdherenceScore,_that.dailyData,_that.micronutrients);case _:
  return null;
...
class _NutritionAnalytics extends NutritionAnalytics {
  const _NutritionAnalytics({@JsonKey(name: 'adherenceScore') this.macroAdherenceScore = 0, final  List<DailyNutrition> dailyData = const [], final  List<MicronutrientSummary> micronutrients = const []}): _dailyData = dailyData,_micronutrients = micronutrients,super._();
  factory _NutritionAnalytics.fromJson(Map<String, dynamic> json) => _$NutritionAnalyticsFromJson(json);

@override@JsonKey(name: 'adherenceScore') final  double macroAdherenceScore;
...
switch (_that) {
case _DailyNutrition():
return $default(_that.date,_that.calories,_that.protein,_that.carbs,_that.fat);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _DailyNutrition extends DailyNutrition {
  const _DailyNutrition({required this.date, this.calories = 0, this.protein = 0, this.carbs = 0, this.fat = 0}): super._();
...
switch (_that) {
case _SupplementAnalytics():
return $default(_that.overallAdherence,_that.avgDailyDoses,_that.totalSupplements,_that.totalScheduled,_that.totalTaken,_that.totalDays,_that.supplements);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
$SavedMealCopyWith<SavedMeal> get copyWith => _$SavedMealCopyWithImpl<SavedMeal>(this as SavedMeal, _$identity);
  ...
  /// Serializes this SavedMeal to a JSON map.
  Map<String, dynamic> toJson();
...
switch (_that) {
case _SavedMeal():
return $default(_that.id,_that.userId,_that.name,_that.totalCalories,_that.totalProtein,_that.totalCarbs,_that.totalFat,_that.items);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _SavedMeal extends SavedMeal {
  const _SavedMeal({required this.id, required this.userId, required this.name, required this.totalCalories, required this.totalProtein, required this.totalCarbs, required this.totalFat, required final  List<SavedMealItem> items}): _items = items,super._();
  factory _SavedMeal.fromJson(Map<String, dynamic> json) => _$SavedMealFromJson(json);
...
$SavedMealItemCopyWith<SavedMealItem> get copyWith => _$SavedMealItemCopyWithImpl<SavedMealItem>(this as SavedMealItem, _$identity);
  ...
  /// Serializes this SavedMealItem to a JSON map.
  Map<String, dynamic> toJson();
...
switch (_that) {
case _SavedMealItem():
return $default(_that.id,_that.savedMealId,_that.name,_that.estimatedGrams,_that.calories,_that.protein,_that.carbs,_that.fat);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class _SavedMealItem extends SavedMealItem {
  const _SavedMealItem({required this.id, required this.savedMealId, required this.name, required this.estimatedGrams, required this.calories, required this.protein, required this.carbs, required this.fat}): super._();
  factory _SavedMealItem.fromJson(Map<String, dynamic> json) => _$SavedMealItemFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$SavedMealItemToJson(this, );
}
