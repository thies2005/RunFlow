...
export function FoodScannerModal({ isOpen, onClose, onScanComplete }: Props) {
    ...
    const handleAnalyze = async () => {
        if (!imageBase64 || !session?.user?.id) return;
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    <p className="text-white font-medium mb-1">Take a Photo or Upload</p>
                                ...
                                <button
                                    onClick={() => {
                                        if (fileInputRef.current) {
                                            ...
                                            // Re-add capture attribute after a small delay
                                            setTimeout(() => {
                        ...
                        <div className="flex-1 flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder='e.g. "salad with 2 spoons of olive oil"'
                                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-amber-500/50 transition-colors"
                                    disabled={isAnalyzing}
                                />
                                <p className="text-[11px] text-gray-500 mt-1.5 ml-1">
                                    Help the AI identify ingredients, sauces, or portions for better accuracy
                                </p>
                            </div>
