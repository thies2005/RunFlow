...
class _NutritionLog implements NutritionLog {
  const _NutritionLog({required this.id, required this.date, required this.calories, required this.protein, required this.carbs, required this.fat, required this.water, this.notes, required this.createdAt});
...
mixin _$FoodItem {
 ...
 int get id; String get name; double get calories; double get protein; double get carbs; double get fat; double get servingSize; String? get brand; String? get barcode; String? get favoriteId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FoodItem&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.calories, calories) || other.calories == calories)&&(identical(other.protein, protein) || other.protein == protein)&&(identical(other.carbs, carbs) || other.carbs == carbs)&&(identical(other.fat, fat) || other.fat == fat)&&(identical(other.servingSize, servingSize) || other.servingSize == servingSize)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.barcode, barcode) || other.barcode == barcode)&&(identical(other.favoriteId, favoriteId) || other.favoriteId == favoriteId));
}


@override
int get hashCode => Object.hash(runtimeType,id,name,calories,protein,carbs,fat,servingSize,brand,barcode,favoriteId);

@override
String toString() {
  return 'FoodItem(id: $id, name: $name, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat, servingSize: $servingSize, brand: $brand, barcode: $barcode, favoriteId: $favoriteId)';
}
...
@useResult
$Res call({
 int id, String name, double calories, double protein, double carbs, double fat, double servingSize, String? brand, String? barcode, String? favoriteId
});
...
/// Create a copy of FoodItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? servingSize = null,Object? brand = freezed,Object? barcode = freezed,Object? favoriteId = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
as String?,favoriteId: freezed == favoriteId ? _self.favoriteId : favoriteId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  double calories,  double protein,  double carbs,  double fat,  double servingSize,  String? brand,  String? barcode,  String? favoriteId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FoodItem() when $default != null:
return $default(_that.id,_that.name,_that.calories,_that.protein,_that.carbs,_that.fat,_that.servingSize,_that.brand,_that.barcode,_that.favoriteId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  double calories,  double protein,  double carbs,  double fat,  double servingSize,  String? brand,  String? barcode,  String? favoriteId)  $default,) {final _that = this;
switch (_that) {
case _FoodItem():
return $default(_that.id,_that.name,_that.calories,_that.protein,_that.carbs,_that.fat,_that.servingSize,_that.brand,_that.barcode,_that.favoriteId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  double calories,  double protein,  double carbs,  double fat,  double servingSize,  String? brand,  String? barcode,  String? favoriteId)?  $default,) {final _that = this;
switch (_that) {
case _FoodItem() when $default != null:
return $default(_that.id,_that.name,_that.calories,_that.protein,_that.carbs,_that.fat,_that.servingSize,_that.brand,_that.barcode,_that.favoriteId);case _:
  return null;
...
class _FoodItem extends FoodItem {
  const _FoodItem({required this.id, required this.name, required this.calories, required this.protein, required this.carbs, required this.fat, required this.servingSize, this.brand, this.barcode, this.favoriteId}): super._();
...
/// Create a copy of FoodItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? servingSize = null,Object? brand = freezed,Object? barcode = freezed,Object? favoriteId = freezed,}) {
...
mixin _$Supplement {
 ...
 int get id; String? get serverId; String get name; double get amount; String get unit; String get timeOfDay; List<int> get daysOfWeek; bool get isActive; String? get stackId; int get order; String get dosage; String get frequency;
...
@useResult
$Res call({
 int id, String? serverId, String name, double amount, String unit, String timeOfDay, List<int> daysOfWeek, bool isActive, String? stackId, int order, String dosage, String frequency
});
...
/// Create a copy of Supplement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? serverId = freezed,Object? name = null,Object? amount = null,Object? unit = null,Object? timeOfDay = null,Object? daysOfWeek = null,Object? isActive = null,Object? stackId = freezed,Object? order = null,Object? dosage = null,Object? frequency = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String? serverId,  String name,  double amount,  String unit,  String timeOfDay,  List<int> daysOfWeek,  bool isActive,  String? stackId,  int order,  String dosage,  String frequency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Supplement() when $default != null:
return $default(_that.id,_that.serverId,_that.name,_that.amount,_that.unit,_that.timeOfDay,_that.daysOfWeek,_that.isActive,_that.stackId,_that.order,_that.dosage,_that.frequency);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String? serverId,  String name,  double amount,  String unit,  String timeOfDay,  List<int> daysOfWeek,  bool isActive,  String? stackId,  int order,  String dosage,  String frequency)  $default,) {final _that = this;
switch (_that) {
case _Supplement():
return $default(_that.id,_that.serverId,_that.name,_that.amount,_that.unit,_that.timeOfDay,_that.daysOfWeek,_that.isActive,_that.stackId,_that.order,_that.dosage,_that.frequency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String? serverId,  String name,  double amount,  String unit,  String timeOfDay,  List<int> daysOfWeek,  bool isActive,  String? stackId,  int order,  String dosage,  String frequency)?  $default,) {final _that = this;
switch (_that) {
case _Supplement() when $default != null:
return $default(_that.id,_that.serverId,_that.name,_that.amount,_that.unit,_that.timeOfDay,_that.daysOfWeek,_that.isActive,_that.stackId,_that.order,_that.dosage,_that.frequency);case _:
  return null;
...
class _Supplement extends Supplement {
  const _Supplement({required this.id, this.serverId, required this.name, this.amount = 0, this.unit = 'mg', this.timeOfDay = 'MORNING', final  List<int> daysOfWeek = const [], this.isActive = true, this.stackId, this.order = 0, this.dosage = '', this.frequency = 'Daily'}): _daysOfWeek = daysOfWeek,super._();
...
/// Create a copy of Supplement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? serverId = freezed,Object? name = null,Object? amount = null,Object? unit = null,Object? timeOfDay = null,Object? daysOfWeek = null,Object? isActive = null,Object? stackId = freezed,Object? order = null,Object? dosage = null,Object? frequency = null,}) {
...
class _SupplementStack implements SupplementStack {
  const _SupplementStack({required this.id, required this.name, required final  List<Supplement> supplements, required this.isActive}): _supplements = supplements;
...
class _DailyHealthLog implements DailyHealthLog {
  const _DailyHealthLog({required this.id, required this.date, this.steps = 0, this.weight, this.waterIntake = 0, this.exerciseCalories = 0, final  List<SupplementLog> supplementLogs = const [], final  List<FoodLogEntry> foodLogs = const [], this.meta}): _supplementLogs = supplementLogs,_foodLogs = foodLogs;
...
class _SupplementLog implements SupplementLog {
  const _SupplementLog({required this.supplementId, required this.date, this.taken = false});
...
mixin _$FoodLogEntry {
 ...
 String get id; String get mealType; String get name; double? get quantity; double? get calories; double? get protein; double? get carbs; double? get fat; String? get foodItemId;
...
@override
int get hashCode => Object.hash(runtimeType,id,mealType,name,quantity,calories,protein,carbs,fat,foodItemId);

@override
String toString() {
  return 'FoodLogEntry(id: $id, mealType: $mealType, name: $name, quantity: $quantity, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat, foodItemId: $foodItemId)';
}
...
@useResult
$Res call({
 String id, String mealType, String name, double? quantity, double? calories, double? protein, double? carbs, double? fat, String? foodItemId
});
...
/// Create a copy of FoodLogEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? mealType = null,Object? name = null,Object? quantity = freezed,Object? calories = freezed,Object? protein = freezed,Object? carbs = freezed,Object? fat = freezed,Object? foodItemId = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String mealType,  String name,  double? quantity,  double? calories,  double? protein,  double? carbs,  double? fat,  String? foodItemId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FoodLogEntry() when $default != null:
return $default(_that.id,_that.mealType,_that.name,_that.quantity,_that.calories,_that.protein,_that.carbs,_that.fat,_that.foodItemId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String mealType,  String name,  double? quantity,  double? calories,  double? protein,  double? carbs,  double? fat,  String? foodItemId)  $default,) {final _that = this;
switch (_that) {
case _FoodLogEntry():
return $default(_that.id,_that.mealType,_that.name,_that.quantity,_that.calories,_that.protein,_that.carbs,_that.fat,_that.foodItemId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String mealType,  String name,  double? quantity,  double? calories,  double? protein,  double? carbs,  double? fat,  String? foodItemId)?  $default,) {final _that = this;
switch (_that) {
case _FoodLogEntry() when $default != null:
return $default(_that.id,_that.mealType,_that.name,_that.quantity,_that.calories,_that.protein,_that.carbs,_that.fat,_that.foodItemId);case _:
  return null;
...
class _FoodLogEntry implements FoodLogEntry {
  const _FoodLogEntry({this.id = '', required this.mealType, required this.name, this.quantity, this.calories, this.protein, this.carbs, this.fat, this.foodItemId});
...
/// Create a copy of FoodLogEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? mealType = null,Object? name = null,Object? quantity = freezed,Object? calories = freezed,Object? protein = freezed,Object? carbs = freezed,Object? fat = freezed,Object? foodItemId = freezed,}) {
...
class _DailyHealthMeta implements DailyHealthMeta {
  const _DailyHealthMeta({this.hasStepHistory = false});
...
class _FastingSession implements FastingSession {
  const _FastingSession({required this.id, required this.startTime, this.endTime, required this.duration, required this.isActive});
...
/// @nodoc
mixin _$FastingSchedule {

 int get fastingStartHour; int get fastingStartMinute; int get fastingEndHour; int get fastingEndMinute; double get targetHours; bool get isEnabled;
/// Create a copy of FastingSchedule
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FastingScheduleCopyWith<FastingSchedule> get copyWith => _$FastingScheduleCopyWithImpl<FastingSchedule>(this as FastingSchedule, _$identity);

  /// Serializes this FastingSchedule to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FastingSchedule&&(identical(other.fastingStartHour, fastingStartHour) || other.fastingStartHour == fastingStartHour)&&(identical(other.fastingStartMinute, fastingStartMinute) || other.fastingStartMinute == fastingStartMinute)&&(identical(other.fastingEndHour, fastingEndHour) || other.fastingEndHour == fastingEndHour)&&(identical(other.fastingEndMinute, fastingEndMinute) || other.fastingEndMinute == fastingEndMinute)&&(identical(other.targetHours, targetHours) || other.targetHours == targetHours)&&(identical(other.isEnabled, isEnabled) || other.isEnabled == isEnabled));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,fastingStartHour,fastingStartMinute,fastingEndHour,fastingEndMinute,targetHours,isEnabled);

@override
String toString() {
  return 'FastingSchedule(fastingStartHour: $fastingStartHour, fastingStartMinute: $fastingStartMinute, fastingEndHour: $fastingEndHour, fastingEndMinute: $fastingEndMinute, targetHours: $targetHours, isEnabled: $isEnabled)';
}
...
/// @nodoc
abstract mixin class $FastingScheduleCopyWith<$Res>  {
  factory $FastingScheduleCopyWith(FastingSchedule value, $Res Function(FastingSchedule) _then) = _$FastingScheduleCopyWithImpl;
@useResult
$Res call({
 int fastingStartHour, int fastingStartMinute, int fastingEndHour, int fastingEndMinute, double targetHours, bool isEnabled
});
...
/// @nodoc
class _$FastingScheduleCopyWithImpl<$Res>
    implements $FastingScheduleCopyWith<$Res> {
  _$FastingScheduleCopyWithImpl(this._self, this._then);

  final FastingSchedule _self;
  final $Res Function(FastingSchedule) _then;

/// Create a copy of FastingSchedule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? fastingStartHour = null,Object? fastingStartMinute = null,Object? fastingEndHour = null,Object? fastingEndMinute = null,Object? targetHours = null,Object? isEnabled = null,}) {
  return _then(_self.copyWith(
fastingStartHour: null == fastingStartHour ? _self.fastingStartHour : fastingStartHour // ignore: cast_nullable_to_non_nullable
as int,fastingStartMinute: null == fastingStartMinute ? _self.fastingStartMinute : fastingStartMinute // ignore: cast_nullable_to_non_nullable
as int,fastingEndHour: null == fastingEndHour ? _self.fastingEndHour : fastingEndHour // ignore: cast_nullable_to_non_nullable
as int,fastingEndMinute: null == fastingEndMinute ? _self.fastingEndMinute : fastingEndMinute // ignore: cast_nullable_to_non_nullable
as int,targetHours: null == targetHours ? _self.targetHours : targetHours // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [FastingSchedule].
extension FastingSchedulePatterns on FastingSchedule {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FastingSchedule value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FastingSchedule() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FastingSchedule value)  $default,){
final _that = this;
switch (_that) {
case _FastingSchedule():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FastingSchedule value)?  $default,){
final _that = this;
switch (_that) {
case _FastingSchedule() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int fastingStartHour,  int fastingStartMinute,  int fastingEndHour,  int fastingEndMinute,  double targetHours,  bool isEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FastingSchedule() when $default != null:
return $default(_that.fastingStartHour,_that.fastingStartMinute,_that.fastingEndHour,_that.fastingEndMinute,_that.targetHours,_that.isEnabled);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int fastingStartHour,  int fastingStartMinute,  int fastingEndHour,  int fastingEndMinute,  double targetHours,  bool isEnabled)  $default,) {final _that = this;
switch (_that) {
case _FastingSchedule():
return $default(_that.fastingStartHour,_that.fastingStartMinute,_that.fastingEndHour,_that.fastingEndMinute,_that.targetHours,_that.isEnabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int fastingStartHour,  int fastingStartMinute,  int fastingEndHour,  int fastingEndMinute,  double targetHours,  bool isEnabled)?  $default,) {final _that = this;
switch (_that) {
case _FastingSchedule() when $default != null:
return $default(_that.fastingStartHour,_that.fastingStartMinute,_that.fastingEndHour,_that.fastingEndMinute,_that.targetHours,_that.isEnabled);case _:
  return null;
...
class _FastingSchedule extends FastingSchedule {
  const _FastingSchedule({this.fastingStartHour = 20, this.fastingStartMinute = 0, this.fastingEndHour = 12, this.fastingEndMinute = 0, this.targetHours = 16.0, this.isEnabled = false}): super._();
  factory _FastingSchedule.fromJson(Map<String, dynamic> json) => _$FastingScheduleFromJson(json);

@override@JsonKey() final  int fastingStartHour;
@override@JsonKey() final  int fastingStartMinute;
@override@JsonKey() final  int fastingEndHour;
@override@JsonKey() final  int fastingEndMinute;
@override@JsonKey() final  double targetHours;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FastingScheduleCopyWith<_FastingSchedule> get copyWith => __$FastingScheduleCopyWithImpl<_FastingSchedule>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$FastingScheduleToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FastingSchedule&&(identical(other.fastingStartHour, fastingStartHour) || other.fastingStartHour == fastingStartHour)&&(identical(other.fastingStartMinute, fastingStartMinute) || other.fastingStartMinute == fastingStartMinute)&&(identical(other.fastingEndHour, fastingEndHour) || other.fastingEndHour == fastingEndHour)&&(identical(other.fastingEndMinute, fastingEndMinute) || other.fastingEndMinute == fastingEndMinute)&&(identical(other.targetHours, targetHours) || other.targetHours == targetHours)&&(identical(other.isEnabled, isEnabled) || other.isEnabled == isEnabled));
}
...
/// @nodoc
abstract mixin class _$FastingScheduleCopyWith<$Res> implements $FastingScheduleCopyWith<$Res> {
  factory _$FastingScheduleCopyWith(_FastingSchedule value, $Res Function(_FastingSchedule) _then) = __$FastingScheduleCopyWithImpl;
@override @useResult
$Res call({
 int fastingStartHour, int fastingStartMinute, int fastingEndHour, int fastingEndMinute, double targetHours, bool isEnabled
});
...
/// @nodoc
class __$FastingScheduleCopyWithImpl<$Res>
    implements _$FastingScheduleCopyWith<$Res> {
  __$FastingScheduleCopyWithImpl(this._self, this._then);

  final _FastingSchedule _self;
  final $Res Function(_FastingSchedule) _then;

/// Create a copy of FastingSchedule
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fastingStartHour = null,Object? fastingStartMinute = null,Object? fastingEndHour = null,Object? fastingEndMinute = null,Object? targetHours = null,Object? isEnabled = null,}) {
  return _then(_FastingSchedule(
fastingStartHour: null == fastingStartHour ? _self.fastingStartHour : fastingStartHour // ignore: cast_nullable_to_non_nullable
as int,fastingStartMinute: null == fastingStartMinute ? _self.fastingStartMinute : fastingStartMinute // ignore: cast_nullable_to_non_nullable
as int,fastingEndHour: null == fastingEndHour ? _self.fastingEndHour : fastingEndHour // ignore: cast_nullable_to_non_nullable
as int,fastingEndMinute: null == fastingEndMinute ? _self.fastingEndMinute : fastingEndMinute // ignore: cast_nullable_to_non_nullable
...
class _BodyMeasurement implements BodyMeasurement {
  const _BodyMeasurement({required this.id, required this.date, required this.weight, required this.bodyFat, this.chest, this.waist, this.hips, this.arms, this.notes});
...
mixin _$NutritionTargets {
 ...
 int get calories; int get protein; int get carbs; int get fat; double get water; double get proteinPercent; double get carbsPercent; double get fatPercent; int get waterGoalMl; double get exerciseCalorieFactor; String get exerciseCalorieSource; bool get waterTrackingEnabled;
/// Create a copy of NutritionTargets
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NutritionTargetsCopyWith<NutritionTargets> get copyWith => _$NutritionTargetsCopyWithImpl<NutritionTargets>(this as NutritionTargets, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NutritionTargets&&(identical(other.calories, calories) || other.calories == calories)&&(identical(other.protein, protein) || other.protein == protein)&&(identical(other.carbs, carbs) || other.carbs == carbs)&&(identical(other.fat, fat) || other.fat == fat)&&(identical(other.water, water) || other.water == water)&&(identical(other.proteinPercent, proteinPercent) || other.proteinPercent == proteinPercent)&&(identical(other.carbsPercent, carbsPercent) || other.carbsPercent == carbsPercent)&&(identical(other.fatPercent, fatPercent) || other.fatPercent == fatPercent)&&(identical(other.waterGoalMl, waterGoalMl) || other.waterGoalMl == waterGoalMl)&&(identical(other.exerciseCalorieFactor, exerciseCalorieFactor) || other.exerciseCalorieFactor == exerciseCalorieFactor)&&(identical(other.exerciseCalorieSource, exerciseCalorieSource) || other.exerciseCalorieSource == exerciseCalorieSource)&&(identical(other.waterTrackingEnabled, waterTrackingEnabled) || other.waterTrackingEnabled == waterTrackingEnabled));
}


@override
int get hashCode => Object.hash(runtimeType,calories,protein,carbs,fat,water,proteinPercent,carbsPercent,fatPercent,waterGoalMl,exerciseCalorieFactor,exerciseCalorieSource,waterTrackingEnabled);

@override
String toString() {
  return 'NutritionTargets(calories: $calories, protein: $protein, carbs: $carbs, fat: $fat, water: $water, proteinPercent: $proteinPercent, carbsPercent: $carbsPercent, fatPercent: $fatPercent, waterGoalMl: $waterGoalMl, exerciseCalorieFactor: $exerciseCalorieFactor, exerciseCalorieSource: $exerciseCalorieSource, waterTrackingEnabled: $waterTrackingEnabled)';
}
...
abstract mixin class $NutritionTargetsCopyWith<$Res>  {
  factory $NutritionTargetsCopyWith(NutritionTargets value, $Res Function(NutritionTargets) _then) = _$NutritionTargetsCopyWithImpl;
@useResult
$Res call({
 int calories, int protein, int carbs, int fat, double water, double proteinPercent, double carbsPercent, double fatPercent, int waterGoalMl, double exerciseCalorieFactor, String exerciseCalorieSource, bool waterTrackingEnabled
});
...
/// Create a copy of NutritionTargets
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? water = null,Object? proteinPercent = null,Object? carbsPercent = null,Object? fatPercent = null,Object? waterGoalMl = null,Object? exerciseCalorieFactor = null,Object? exerciseCalorieSource = null,Object? waterTrackingEnabled = null,}) {
  return _then(_self.copyWith(
...
as double,proteinPercent: null == proteinPercent ? _self.proteinPercent : proteinPercent // ignore: cast_nullable_to_non_nullable
...
as double,waterGoalMl: null == waterGoalMl ? _self.waterGoalMl : waterGoalMl // ignore: cast_nullable_to_non_nullable
as int,exerciseCalorieFactor: null == exerciseCalorieFactor ? _self.exerciseCalorieFactor : exerciseCalorieFactor // ignore: cast_nullable_to_non_nullable
as double,exerciseCalorieSource: null == exerciseCalorieSource ? _self.exerciseCalorieSource : exerciseCalorieSource // ignore: cast_nullable_to_non_nullable
as String,waterTrackingEnabled: null == waterTrackingEnabled ? _self.waterTrackingEnabled : waterTrackingEnabled // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _NutritionTargets value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _NutritionTargets value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _NutritionTargets value)?  $default,){
final _that = this;
switch (_that) {
case _NutritionTargets() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int calories,  int protein,  int carbs,  int fat,  double water,  double proteinPercent,  double carbsPercent,  double fatPercent,  int waterGoalMl,  double exerciseCalorieFactor,  String exerciseCalorieSource,  bool waterTrackingEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NutritionTargets() when $default != null:
return $default(_that.calories,_that.protein,_that.carbs,_that.fat,_that.water,_that.proteinPercent,_that.carbsPercent,_that.fatPercent,_that.waterGoalMl,_that.exerciseCalorieFactor,_that.exerciseCalorieSource,_that.waterTrackingEnabled);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int calories,  int protein,  int carbs,  int fat,  double water,  double proteinPercent,  double carbsPercent,  double fatPercent,  int waterGoalMl,  double exerciseCalorieFactor,  String exerciseCalorieSource,  bool waterTrackingEnabled)  $default,) {final _that = this;
switch (_that) {
case _NutritionTargets():
return $default(_that.calories,_that.protein,_that.carbs,_that.fat,_that.water,_that.proteinPercent,_that.carbsPercent,_that.fatPercent,_that.waterGoalMl,_that.exerciseCalorieFactor,_that.exerciseCalorieSource,_that.waterTrackingEnabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int calories,  int protein,  int carbs,  int fat,  double water,  double proteinPercent,  double carbsPercent,  double fatPercent,  int waterGoalMl,  double exerciseCalorieFactor,  String exerciseCalorieSource,  bool waterTrackingEnabled)?  $default,) {final _that = this;
switch (_that) {
case _NutritionTargets() when $default != null:
return $default(_that.calories,_that.protein,_that.carbs,_that.fat,_that.water,_that.proteinPercent,_that.carbsPercent,_that.fatPercent,_that.waterGoalMl,_that.exerciseCalorieFactor,_that.exerciseCalorieSource,_that.waterTrackingEnabled);case _:
  return null;
...
class _NutritionTargets extends NutritionTargets {
  const _NutritionTargets({required this.calories, required this.protein, required this.carbs, required this.fat, required this.water, this.proteinPercent = 30, this.carbsPercent = 40, this.fatPercent = 30, this.waterGoalMl = 2500, this.exerciseCalorieFactor = 0.5, this.exerciseCalorieSource = 'strava', this.waterTrackingEnabled = false}): super._();
...
@override final  double water;
@override@JsonKey() final  double proteinPercent;
@override@JsonKey() final  double carbsPercent;
@override@JsonKey() final  double fatPercent;
@override@JsonKey() final  int waterGoalMl;
@override@JsonKey() final  double exerciseCalorieFactor;
@override@JsonKey() final  String exerciseCalorieSource;
@override@JsonKey() final  bool waterTrackingEnabled;

/// Create a copy of NutritionTargets
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$NutritionTargetsCopyWith<_NutritionTargets> get copyWith => __$NutritionTargetsCopyWithImpl<_NutritionTargets>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NutritionTargets&&(identical(other.calories, calories) || other.calories == calories)&&(identical(other.protein, protein) || other.protein == protein)&&(identical(other.carbs, carbs) || other.carbs == carbs)&&(identical(other.fat, fat) || other.fat == fat)&&(identical(other.water, water) || other.water == water)&&(identical(other.proteinPercent, proteinPercent) || other.proteinPercent == proteinPercent)&&(identical(other.carbsPercent, carbsPercent) || other.carbsPercent == carbsPercent)&&(identical(other.fatPercent, fatPercent) || other.fatPercent == fatPercent)&&(identical(other.waterGoalMl, waterGoalMl) || other.waterGoalMl == waterGoalMl)&&(identical(other.exerciseCalorieFactor, exerciseCalorieFactor) || other.exerciseCalorieFactor == exerciseCalorieFactor)&&(identical(other.exerciseCalorieSource, exerciseCalorieSource) || other.exerciseCalorieSource == exerciseCalorieSource)&&(identical(other.waterTrackingEnabled, waterTrackingEnabled) || other.waterTrackingEnabled == waterTrackingEnabled));
}
...
/// @nodoc
abstract mixin class _$NutritionTargetsCopyWith<$Res> implements $NutritionTargetsCopyWith<$Res> {
  factory _$NutritionTargetsCopyWith(_NutritionTargets value, $Res Function(_NutritionTargets) _then) = __$NutritionTargetsCopyWithImpl;
@override @useResult
$Res call({
 int calories, int protein, int carbs, int fat, double water, double proteinPercent, double carbsPercent, double fatPercent, int waterGoalMl, double exerciseCalorieFactor, String exerciseCalorieSource, bool waterTrackingEnabled
});
...
/// Create a copy of NutritionTargets
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,Object? water = null,Object? proteinPercent = null,Object? carbsPercent = null,Object? fatPercent = null,Object? waterGoalMl = null,Object? exerciseCalorieFactor = null,Object? exerciseCalorieSource = null,Object? waterTrackingEnabled = null,}) {
...
class _NutritionAnalytics implements NutritionAnalytics {
  const _NutritionAnalytics({this.macroAdherenceScore = 0, final  List<DailyNutrition> dailyData = const [], final  List<MicronutrientSummary> micronutrients = const []}): _dailyData = dailyData,_micronutrients = micronutrients;
...
class _DailyNutrition implements DailyNutrition {
  const _DailyNutrition({required this.date, this.calories = 0, this.protein = 0, this.carbs = 0, this.fat = 0});
...
class _MicronutrientSummary implements MicronutrientSummary {
  const _MicronutrientSummary({required this.name, this.amount = 0, this.unit = '', this.dailyValuePercent = 0});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SupplementAnalytics&&(identical(other.overallAdherence, overallAdherence) || other.overallAdherence == overallAdherence)&&(identical(other.avgDailyDoses, avgDailyDoses) || other.avgDailyDoses == avgDailyDoses)&&(identical(other.totalSupplements, totalSupplements) || other.totalSupplements == totalSupplements)&&(identical(other.totalScheduled, totalScheduled) || other.totalScheduled == totalScheduled)&&(identical(other.totalTaken, totalTaken) || other.totalTaken == totalTaken)&&(identical(other.totalDays, totalDays) || other.totalDays == totalDays)&&const DeepCollectionEquality().equals(other.supplements, supplements));
}
...
@useResult
$Res call({
 double overallAdherence, double avgDailyDoses, int totalSupplements, int totalScheduled, int totalTaken, int totalDays, List<SupplementAdherence> supplements
});
...
/// Create a copy of SupplementAnalytics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? overallAdherence = null,Object? avgDailyDoses = null,Object? totalSupplements = null,Object? totalScheduled = null,Object? totalTaken = null,Object? totalDays = null,Object? supplements = null,}) {
  return _then(_self.copyWith(
overallAdherence: null == overallAdherence ? _self.overallAdherence : overallAdherence // ignore: cast_nullable_to_non_nullable
as double,avgDailyDoses: null == avgDailyDoses ? _self.avgDailyDoses : avgDailyDoses // ignore: cast_nullable_to_non_nullable
as double,totalSupplements: null == totalSupplements ? _self.totalSupplements : totalSupplements // ignore: cast_nullable_to_non_nullable
as int,totalScheduled: null == totalScheduled ? _self.totalScheduled : totalScheduled // ignore: cast_nullable_to_non_nullable
as int,totalTaken: null == totalTaken ? _self.totalTaken : totalTaken // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double overallAdherence,  double avgDailyDoses,  int totalSupplements,  int totalScheduled,  int totalTaken,  int totalDays,  List<SupplementAdherence> supplements)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SupplementAnalytics() when $default != null:
return $default(_that.overallAdherence,_that.avgDailyDoses,_that.totalSupplements,_that.totalScheduled,_that.totalTaken,_that.totalDays,_that.supplements);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double overallAdherence,  double avgDailyDoses,  int totalSupplements,  int totalScheduled,  int totalTaken,  int totalDays,  List<SupplementAdherence> supplements)  $default,) {final _that = this;
switch (_that) {
case _SupplementAnalytics():
return $default(_that.overallAdherence,_that.avgDailyDoses,_that.totalSupplements,_that.totalScheduled,_that.totalTaken,_that.totalDays,_that.supplements);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double overallAdherence,  double avgDailyDoses,  int totalSupplements,  int totalScheduled,  int totalTaken,  int totalDays,  List<SupplementAdherence> supplements)?  $default,) {final _that = this;
switch (_that) {
case _SupplementAnalytics() when $default != null:
return $default(_that.overallAdherence,_that.avgDailyDoses,_that.totalSupplements,_that.totalScheduled,_that.totalTaken,_that.totalDays,_that.supplements);case _:
  return null;
...
class _SupplementAnalytics implements SupplementAnalytics {
  const _SupplementAnalytics({this.overallAdherence = 0, this.avgDailyDoses = 0, this.totalSupplements = 0, this.totalScheduled = 0, this.totalTaken = 0, this.totalDays = 0, final  List<SupplementAdherence> supplements = const []}): _supplements = supplements;
  

@override@JsonKey() final  double overallAdherence;
@override@JsonKey() final  double avgDailyDoses;
@override@JsonKey() final  int totalSupplements;
@override@JsonKey() final  int totalScheduled;
@override@JsonKey() final  int totalTaken;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SupplementAnalytics&&(identical(other.overallAdherence, overallAdherence) || other.overallAdherence == overallAdherence)&&(identical(other.avgDailyDoses, avgDailyDoses) || other.avgDailyDoses == avgDailyDoses)&&(identical(other.totalSupplements, totalSupplements) || other.totalSupplements == totalSupplements)&&(identical(other.totalScheduled, totalScheduled) || other.totalScheduled == totalScheduled)&&(identical(other.totalTaken, totalTaken) || other.totalTaken == totalTaken)&&(identical(other.totalDays, totalDays) || other.totalDays == totalDays)&&const DeepCollectionEquality().equals(other._supplements, _supplements));
}
...
/// Create a copy of SupplementAnalytics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? overallAdherence = null,Object? avgDailyDoses = null,Object? totalSupplements = null,Object? totalScheduled = null,Object? totalTaken = null,Object? totalDays = null,Object? supplements = null,}) {
...
class _SupplementAdherence implements SupplementAdherence {
  const _SupplementAdherence({required this.name, this.adherencePercent = 0, this.daysTaken = 0, this.totalDays = 0});
...
class _HealthHistory implements HealthHistory {
  const _HealthHistory({final  List<HealthHistoryPoint> steps = const [], final  List<HealthHistoryPoint> weight = const []}): _steps = steps,_weight = weight;
...
class _HealthHistoryPoint implements HealthHistoryPoint {
  const _HealthHistoryPoint({required this.date, required this.value});
...
mixin _$SavedMeal {
 ...
 String get id; String get userId; String get name; double get totalCalories; double get totalProtein; double get totalCarbs; double get totalFat; List<SavedMealItem> get items;
/// Create a copy of SavedMeal
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SavedMealCopyWith<SavedMeal> get copyWith => _$SavedMealCopyWithImpl<SavedMeal>(this as SavedMeal, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SavedMeal&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.name, name) || other.name == name)&&(identical(other.totalCalories, totalCalories) || other.totalCalories == totalCalories)&&(identical(other.totalProtein, totalProtein) || other.totalProtein == totalProtein)&&(identical(other.totalCarbs, totalCarbs) || other.totalCarbs == totalCarbs)&&(identical(other.totalFat, totalFat) || other.totalFat == totalFat)&&const DeepCollectionEquality().equals(other.items, items));
}


@override
int get hashCode => Object.hash(runtimeType,id,userId,name,totalCalories,totalProtein,totalCarbs,totalFat,const DeepCollectionEquality().hash(items));

@override
String toString() {
  return 'SavedMeal(id: $id, userId: $userId, name: $name, totalCalories: $totalCalories, totalProtein: $totalProtein, totalCarbs: $totalCarbs, totalFat: $totalFat, items: $items)';
}
...
/// @nodoc
abstract mixin class $SavedMealCopyWith<$Res>  {
  factory $SavedMealCopyWith(SavedMeal value, $Res Function(SavedMeal) _then) = _$SavedMealCopyWithImpl;
@useResult
$Res call({
 String id, String userId, String name, double totalCalories, double totalProtein, double totalCarbs, double totalFat, List<SavedMealItem> items
});
...
/// @nodoc
class _$SavedMealCopyWithImpl<$Res>
    implements $SavedMealCopyWith<$Res> {
  _$SavedMealCopyWithImpl(this._self, this._then);

  final SavedMeal _self;
  final $Res Function(SavedMeal) _then;

/// Create a copy of SavedMeal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? totalCalories = null,Object? totalProtein = null,Object? totalCarbs = null,Object? totalFat = null,Object? items = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [SavedMeal].
extension SavedMealPatterns on SavedMeal {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SavedMeal value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SavedMeal() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SavedMeal value)  $default,){
final _that = this;
switch (_that) {
case _SavedMeal():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SavedMeal value)?  $default,){
final _that = this;
switch (_that) {
case _SavedMeal() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  double totalCalories,  double totalProtein,  double totalCarbs,  double totalFat,  List<SavedMealItem> items)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SavedMeal() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.totalCalories,_that.totalProtein,_that.totalCarbs,_that.totalFat,_that.items);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  double totalCalories,  double totalProtein,  double totalCarbs,  double totalFat,  List<SavedMealItem> items)  $default,) {final _that = this;
switch (_that) {
case _SavedMeal():
return $default(_that.id,_that.userId,_that.name,_that.totalCalories,_that.totalProtein,_that.totalCarbs,_that.totalFat,_that.items);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String name,  double totalCalories,  double totalProtein,  double totalCarbs,  double totalFat,  List<SavedMealItem> items)?  $default,) {final _that = this;
switch (_that) {
case _SavedMeal() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.totalCalories,_that.totalProtein,_that.totalCarbs,_that.totalFat,_that.items);case _:
  return null;
...
class _SavedMeal implements SavedMeal {
  const _SavedMeal({required this.id, required this.userId, required this.name, required this.totalCalories, required this.totalProtein, required this.totalCarbs, required this.totalFat, required final  List<SavedMealItem> items}): _items = items;
...
@override List<SavedMealItem> get items {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SavedMealCopyWith<_SavedMeal> get copyWith => __$SavedMealCopyWithImpl<_SavedMeal>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SavedMeal&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.name, name) || other.name == name)&&(identical(other.totalCalories, totalCalories) || other.totalCalories == totalCalories)&&(identical(other.totalProtein, totalProtein) || other.totalProtein == totalProtein)&&(identical(other.totalCarbs, totalCarbs) || other.totalCarbs == totalCarbs)&&(identical(other.totalFat, totalFat) || other.totalFat == totalFat)&&const DeepCollectionEquality().equals(other._items, _items));
}


@override
int get hashCode => Object.hash(runtimeType,id,userId,name,totalCalories,totalProtein,totalCarbs,totalFat,const DeepCollectionEquality().hash(_items));
...
/// @nodoc
abstract mixin class _$SavedMealCopyWith<$Res> implements $SavedMealCopyWith<$Res> {
  factory _$SavedMealCopyWith(_SavedMeal value, $Res Function(_SavedMeal) _then) = __$SavedMealCopyWithImpl;
@override @useResult
$Res call({
 String id, String userId, String name, double totalCalories, double totalProtein, double totalCarbs, double totalFat, List<SavedMealItem> items
});
...
/// @nodoc
class __$SavedMealCopyWithImpl<$Res>
    implements _$SavedMealCopyWith<$Res> {
  __$SavedMealCopyWithImpl(this._self, this._then);

  final _SavedMeal _self;
  final $Res Function(_SavedMeal) _then;

/// Create a copy of SavedMeal
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? totalCalories = null,Object? totalProtein = null,Object? totalCarbs = null,Object? totalFat = null,Object? items = null,}) {
  return _then(_SavedMeal(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,totalCalories: null == totalCalories ? _self.totalCalories : totalCalories // ignore: cast_nullable_to_non_nullable
...
mixin _$SavedMealItem {
 ...
 String get id; String get savedMealId; String get name; double get estimatedGrams; double get calories; double get protein; double get carbs; double get fat;
/// Create a copy of SavedMealItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SavedMealItemCopyWith<SavedMealItem> get copyWith => _$SavedMealItemCopyWithImpl<SavedMealItem>(this as SavedMealItem, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SavedMealItem&&(identical(other.id, id) || other.id == id)&&(identical(other.savedMealId, savedMealId) || other.savedMealId == savedMealId)&&(identical(other.name, name) || other.name == name)&&(identical(other.estimatedGrams, estimatedGrams) || other.estimatedGrams == estimatedGrams)&&(identical(other.calories, calories) || other.calories == calories)&&(identical(other.protein, protein) || other.protein == protein)&&(identical(other.carbs, carbs) || other.carbs == carbs)&&(identical(other.fat, fat) || other.fat == fat));
}


@override
int get hashCode => Object.hash(runtimeType,id,savedMealId,name,estimatedGrams,calories,protein,carbs,fat);

@override
String toString() {
  return 'SavedMealItem(id: $id, savedMealId: $savedMealId, name: $name, estimatedGrams: $estimatedGrams, calories: $calories, protein: $protein, carbs: $carbs, fat: $fat)';
}
...
/// @nodoc
abstract mixin class $SavedMealItemCopyWith<$Res>  {
  factory $SavedMealItemCopyWith(SavedMealItem value, $Res Function(SavedMealItem) _then) = _$SavedMealItemCopyWithImpl;
@useResult
$Res call({
 String id, String savedMealId, String name, double estimatedGrams, double calories, double protein, double carbs, double fat
});
...
/// @nodoc
class _$SavedMealItemCopyWithImpl<$Res>
    implements $SavedMealItemCopyWith<$Res> {
  _$SavedMealItemCopyWithImpl(this._self, this._then);

  final SavedMealItem _self;
  final $Res Function(SavedMealItem) _then;

/// Create a copy of SavedMealItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? savedMealId = null,Object? name = null,Object? estimatedGrams = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,savedMealId: null == savedMealId ? _self.savedMealId : savedMealId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,estimatedGrams: null == estimatedGrams ? _self.estimatedGrams : estimatedGrams // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [SavedMealItem].
extension SavedMealItemPatterns on SavedMealItem {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SavedMealItem value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _SavedMealItem() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SavedMealItem value)  $default,){
final _that = this;
switch (_that) {
case _SavedMealItem():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SavedMealItem value)?  $default,){
final _that = this;
switch (_that) {
case _SavedMealItem() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String savedMealId,  String name,  double estimatedGrams,  double calories,  double protein,  double carbs,  double fat)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SavedMealItem() when $default != null:
return $default(_that.id,_that.savedMealId,_that.name,_that.estimatedGrams,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String savedMealId,  String name,  double estimatedGrams,  double calories,  double protein,  double carbs,  double fat)  $default,) {final _that = this;
switch (_that) {
case _SavedMealItem():
return $default(_that.id,_that.savedMealId,_that.name,_that.estimatedGrams,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String savedMealId,  String name,  double estimatedGrams,  double calories,  double protein,  double carbs,  double fat)?  $default,) {final _that = this;
switch (_that) {
case _SavedMealItem() when $default != null:
return $default(_that.id,_that.savedMealId,_that.name,_that.estimatedGrams,_that.calories,_that.protein,_that.carbs,_that.fat);case _:
  return null;
...
class _SavedMealItem implements SavedMealItem {
  const _SavedMealItem({required this.id, required this.savedMealId, required this.name, required this.estimatedGrams, required this.calories, required this.protein, required this.carbs, required this.fat});
  

@override final  String id;
@override final  String savedMealId;
@override final  String name;
@override final  double estimatedGrams;
@override final  double calories;
@override final  double protein;
@override final  double carbs;
@override final  double fat;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SavedMealItemCopyWith<_SavedMealItem> get copyWith => __$SavedMealItemCopyWithImpl<_SavedMealItem>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SavedMealItem&&(identical(other.id, id) || other.id == id)&&(identical(other.savedMealId, savedMealId) || other.savedMealId == savedMealId)&&(identical(other.name, name) || other.name == name)&&(identical(other.estimatedGrams, estimatedGrams) || other.estimatedGrams == estimatedGrams)&&(identical(other.calories, calories) || other.calories == calories)&&(identical(other.protein, protein) || other.protein == protein)&&(identical(other.carbs, carbs) || other.carbs == carbs)&&(identical(other.fat, fat) || other.fat == fat));
}
...
/// @nodoc
abstract mixin class _$SavedMealItemCopyWith<$Res> implements $SavedMealItemCopyWith<$Res> {
  factory _$SavedMealItemCopyWith(_SavedMealItem value, $Res Function(_SavedMealItem) _then) = __$SavedMealItemCopyWithImpl;
@override @useResult
$Res call({
 String id, String savedMealId, String name, double estimatedGrams, double calories, double protein, double carbs, double fat
});
...
/// @nodoc
class __$SavedMealItemCopyWithImpl<$Res>
    implements _$SavedMealItemCopyWith<$Res> {
  __$SavedMealItemCopyWithImpl(this._self, this._then);

  final _SavedMealItem _self;
  final $Res Function(_SavedMealItem) _then;

/// Create a copy of SavedMealItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? savedMealId = null,Object? name = null,Object? estimatedGrams = null,Object? calories = null,Object? protein = null,Object? carbs = null,Object? fat = null,}) {
  return _then(_SavedMealItem(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,savedMealId: null == savedMealId ? _self.savedMealId : savedMealId // ignore: cast_nullable_to_non_nullable
as String,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,estimatedGrams: null == estimatedGrams ? _self.estimatedGrams : estimatedGrams // ignore: cast_nullable_to_non_nullable
