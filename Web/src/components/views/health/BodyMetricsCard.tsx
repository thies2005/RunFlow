        ...
        <>
            <div className={`grid gap-4 ${showSteps ? 'grid-cols-2' : 'grid-cols-1'}`}>
                {showSteps && (
                    ...
                    >
                        ...
                        <div className="flex items-baseline gap-1">
                            <span className="text-2xl font-bold text-white">{dailyHealth?.steps || 0}</span>
                        </div>
                    </button>
                )}
                <button
                ...
                >
                    ...
                    <div className="flex items-baseline gap-1">
                        <span className="text-2xl font-bold text-white">{dailyHealth?.weight != null ? dailyHealth.weight.toFixed(1) : '--'}</span>
                        <span className="text-xs text-gray-400 font-medium">kg</span>
                    </div>
                    <p className="text-[11px] text-gray-500 mt-2">{weightLabel}</p>
                </button>
            </div>
